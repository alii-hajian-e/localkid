...
//
//   void startGame() {
//     // اطمینان از اینکه بازی در حال اجرا نیست
//     if (playState == PlayState.playing) return;
//
//     // حذف تمام Overlays
//     overlays.clear();
//
//     // از سرگیری موتور بازی
//     resumeEngine();
//
//     // ریست متغیرهای بازی
...
//
//       AudioManager.playSound('hit.mp3');
//
...
//       otherBall.decreaseHealth(3); // Increased damage for better gameplay
//
...
//         // Play sound on wall hit
//         FlameAudio.play('wall_hit.mp3');
